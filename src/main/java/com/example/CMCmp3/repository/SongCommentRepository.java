...
public interface SongCommentRepository extends JpaRepository<SongComment, Long> {
    ...
    Page<SongComment> findBySongIdAndStatus(Long songId, CommentStatus status, Pageable pageable);
    Page<SongComment> findByStatus(CommentStatus status, Pageable pageable);
}
